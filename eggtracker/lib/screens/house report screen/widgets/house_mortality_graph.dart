...
class HouseMortalityGraph extends StatelessWidget {
  const HouseMortalityGraph({Key? key}) : super(key: key);
              ...
              child: LineChart(
                LineChartData(
                  ...
                  lineBarsData: [
                    LineChartBarData(
                      spots: _isNarrow
                          ? FakeData.houseMortalityNarrow
                          : FakeData.houseMortalityWide,
                      isCurved: true,
                      color: Pal.accent1.withOpacity(0.7),
                      barWidth: 3,
